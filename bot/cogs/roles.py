...
class ReactionRoles(commands.Cog):
    ...
    async def rrlist(self, ctx):
        ...
        embed = discord.Embed(title="<:ownerinfo:1523725199457910884> Reaction Roles", color=0x5865F2)
    ...
    @commands.has_permissions(manage_roles=True)
    async def rrpanel(self, ctx, channel: discord.TextChannel = None, *, title: str = "<:ownerinfo:1523725199457910884> Role Selection"):
        ...
        await ctx.send(embed=make_embed(
            ...
            "Example:\n`<:ownerinfo:1523725199457910884> @Gamer`\n`<:ownerinfo:1523725199457910884> @Music`",
            0x5865F2
        ))
    ...
    async def massrole(self, ctx, role: discord.Role, target: str = "humans"):
        ...
        msg = await ctx.send(embed=make_embed(f"<:ownerinfo:1523725199457910884> Adding {role.mention} to {len(members)} member(s)...", 0x5865F2))
        success, failed = 0, 0
    ...
    async def massunrole(self, ctx, role: discord.Role, target: str = "humans"):
        ...
        msg = await ctx.send(embed=make_embed(f"<:ownerinfo:1523725199457910884> Removing {role.mention} from {len(members)} member(s)...", 0x5865F2))
        success, failed = 0, 0
        for member in members:
            try:
