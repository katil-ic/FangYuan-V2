...
POLL_EMOJIS = ["1<:ownerinfo:1523725199457910884>", "2<:ownerinfo:1523725199457910884>", "3<:ownerinfo:1523725199457910884>", "4<:ownerinfo:1523725199457910884>", "5<:ownerinfo:1523725199457910884>", "6<:ownerinfo:1523725199457910884>", "7<:ownerinfo:1523725199457910884>", "8<:ownerinfo:1523725199457910884>", "9<:ownerinfo:1523725199457910884>", "<:ownerinfo:1523725199457910884>"]
...
class PollResultView(discord.ui.View):
    ...
    @discord.ui.button(label="<a:Poll:1523725207846781071> Results", style=discord.ButtonStyle.secondary, custom_id="poll:results")
    async def show_results(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title=f"<a:Poll:1523725207846781071> Poll Results: {self.poll_data.get('question', 'Poll')}",
...
class Polls(commands.Cog):
    ...
    async def poll(self, ctx, duration: str = None, *, question_and_options: str = None):
        ...
        if not options:
            # Yes/No poll
            embed = discord.Embed(
                title="<a:Poll:1523725207846781071> Poll",
            ...
            if ends_at:
                embed.add_field(name="<:ownerinfo:1523725199457910884> Ends", value=f"<t:{ends_at}:R>", inline=False)
    ...
    async def _auto_end_poll(self, guild_id: int, channel_id: int, msg_id: int, seconds: int, question: str, options: list):
        ...
        try:
            ...
            embed = discord.Embed(
                title="<a:Poll:1523725207846781071> Poll Ended!",
                description=f"**{question}**\n\n" + "\n\n".join(lines),
                color=0x57F287,
                timestamp=datetime.utcnow()
            )
    ...
    async def quickpoll(self, ctx, *, question: str):
        ...
        embed = discord.Embed(
            title="<a:Poll:1523725207846781071> Quick Poll",
            description=f"**{question}**",
            color=0x5865F2,
            timestamp=datetime.utcnow()
        )
    ...
    async def strawpoll(self, ctx, channel: discord.TextChannel = None, *, question_options: str = None):
        ...
        embed = discord.Embed(
            title="<a:Poll:1523725207846781071> Straw Poll",
            color=0xFEE75C,
            timestamp=datetime.utcnow()
        )
        embed.add_field(name="<:ownerinfo:1523725199457910884> Question", value=f"**{question}**", inline=False)
